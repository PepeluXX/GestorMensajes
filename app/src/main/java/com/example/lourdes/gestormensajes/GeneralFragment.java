...
public class GeneralFragment extends android.support.v4.app.Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String RAW_QUERY3 = "SELECT name FROM sqlite_master WHERE type='table' and name like('general')";
        ...
        if(checker.size()>0) {
            ...
            String RAW_QUERY = "SELECT name FROM sqlite_master WHERE type='table' and name  in ('general')";
            //Ejecutar consulta
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                Log.d("categoria", "" + cursor2.getString(6));
            ...
            no_mensajes.setText("No hay mensajes generales.");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_general_fragment, null);
    }
