...
public class PorHijosFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(checker.size()>0) {
            ...
            final LinearLayout layout_principal = (LinearLayout) view.findViewById(R.id.linearLayout2);
            ...
            String RAW_QUERY = "SELECT name FROM sqlite_master WHERE type='table' and name like('hijo%')";
            ;
            //Ejecutar consulta
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                if (nombre_tabla.startsWith("hijo")) {
                    String RAW_QUERY_2 = "SELECT id,autor,fecha,titulo,mensaje,leido FROM '" + nombre_tabla + "'";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_por_hijos_fragment,null);
    }
